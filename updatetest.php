     ...
     <option value=""></option>   
                        ...
                        <td class="td">
                            <select class="dropdown" id="program_release" required ng-model="selectRelease"  name="release">
                                ...
                                <option
                                    ...
                                    name="{{x.progrelease}}">{{ x.progrelease }}</option>
                            </select>
                        </td>
                    </tr>
                </table>
                ...
                <script>
                    ...
                    app.controller('customersCtrl', function ($scope, $http) {
						...
						//selectProgram.progname = progname;
                    });
                </script>
                        ...
                        <td class="td" style="padding-left: 1em">
                            <select class="dropdown" name="reportedby" required>
                                ...
                                foreach ($result as $row) {
                                    echo "<option value=$row[employee_id]" . (strcmp($bug['Reported_by'], $row['employee_name']) == 0 ? " selected" : "") . ">$row[employee_name]</option>";
                                }
                                ?>
                            </select>
                        </td>
                ...
                <table class="table">
                    <tr>
                        ...
                        <td class="td">
                            <select name="assigned_to" class="dropdown">
                                <option></option>
                                <?php
                                ...
                                foreach ($result as $row) {
                                    echo "<option value=$row[employee_id]" . (strcmp($bug['Assigned_to'], $row['employee_name']) == 0 ? " selected" : "") .">$row[employee_name]</option>";
                                }
                                ?>
                            </select>
                        </td>
                ...
                <table class="table">
                    <tr>
                        ...
                        <td class="td" style="padding-left: 3.5em"><select class="dropdown" name="status">
                                <option></option>
                        ...
                        <td class="td"><select class="dropdown" name="resolution">
                                <option></option>
                ...
                <table class="table">
                    <tr>
                        ...
                        <td class="td"><select class="dropdown" name="resolved_by">
                                <option></option>
                                <?php
                                ...
                                foreach ($result as $row) {
                                    echo "<option value=$row[employee_id]" . (strcmp($bug['resolution_by'], $row['employee_name']) == 0 ? " selected" : "") .">$row[employee_name]</option>";
                                }
                                ?>
                            </select></td>
                        <td class="td">Resolution Date</td>
                        <td class="td"><input type="date" style="width: 130px" name="resolved_date" value="<?php if (!is_null($bug['resolution_date'])) {
                                echo "$bug[Reported_date]";
                            } ?>"></td>
                ...
                <table class="table">
                    <tr>
                        ...
                        <td class="td"><select class="dropdown" name="tested_by">
                                <option></option>
                                <?php
                                ...
                                foreach ($result as $row) {
                                    echo "<option value=$row[employee_id] " . (strcmp($bug['resolution_tested_by'], $row['employee_name']) == 0 ? " selected" : "") .">$row[employee_name]</option>";
                                }
                                ?>
                            </select></td>
                        <td width=67 class="td" style="padding-left: 1.2em">Tested Date</td>
                        <td class="td"><input type="date" name="tested_date" style="width: 130px" value="<?php if (!is_null($bug['resolution_tested_date'])) {
                                echo "$bug[Reported_date]";
                            } ?>"></td>
